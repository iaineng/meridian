...
function render(h,s){
  ...
  o+='<div class="section"><div class="section-title">Connect an Agent</div><div class="snippet"><code>export ANTHROPIC_API_KEY=x\\nexport ANTHROPIC_BASE_URL=http://'+location.host+'</code></div><div class="hint">Point any Anthropic-compatible client at this endpoint.</div></div>';
