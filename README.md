...
| `MERIDIAN_MAX_CONCURRENT` | `CLAUDE_PROXY_MAX_CONCURRENT` | `10` | Maximum concurrent SDK sessions. Set to `0` to disable the queue entirely (unlimited concurrency — may OOM the host under heavy load). |
